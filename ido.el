...
(use-package ido
  :init
   nil ;; (global-set-key (kbd "C-x C-f") 'helm-find-files)
  :config
  nil ;;(helm-mode +1)
  )
...
;;(require 'flx-ido)
 ...
 (ido-mode 1)
 (ido-everywhere 1)
;; (ido-ubiquitous-mode 1) ;; deprecated
...
;; requires popup.el ? forget all that - just use straight.el (use-package integration
;;(load "/home/terry/emacs-config/emacs-packages/popup-el/popup")
;; ==========================================================================================
